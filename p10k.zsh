# Generated by Powerlevel10k configuration wizard on 2021-12-18 at 22:55 MSK.
...
# 24h time, 2 lines, dotted, no frame, blue-ornaments, compact, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='[%D{%T %a %b %d}]'
